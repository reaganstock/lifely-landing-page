          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-4 py-24 lg:py-16 relative">
            <div className="text-center max-w-5xl mx-auto mb-20 lg:mb-16">
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-lifeos-dark leading-none mb-8 group cursor-default">
                <span className="inline-block transition-all duration-500 hover:text-lifeos-primary hover:scale-105 hover:-translate-y-2">Vibespeak</span>
                <span className="transition-all duration-300 hover:text-lifeos-secondary"> with</span>
                <br />
                <span className="inline-block transition-all duration-500 hover:text-lifeos-primary hover:scale-105 hover:-translate-y-2">your  </span>
